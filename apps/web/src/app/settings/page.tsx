                  ...
                  >
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className={`w-4 h-4 rounded-full border-2 ${
                        model === m.id ? "border-white bg-white" : "border-zinc-600"
                      }`} />
                    </div>
                  </div>
                ))}
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
              ...
              <div className="space-y-5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  >
                    <div className={`absolute top-0.5 left-0.5 w-5 h-5 rounded-full transition-transform ${
                      autoReview ? "translate-x-5 bg-black" : "translate-x-0 bg-zinc-400"
                    }`} />
                  </button>
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  >
                    <div className={`absolute top-0.5 left-0.5 w-5 h-5 rounded-full transition-transform ${
                      notifications ? "translate-x-5 bg-black" : "translate-x-0 bg-zinc-400"
                    }`} />
                  </button>
                </div>
